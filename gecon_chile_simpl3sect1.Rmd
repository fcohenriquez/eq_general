...
Se va a modelar una economía en que los tres sectores pueden producir los 3 productos.
...
chile_sam <- read.csv("macro_sam_2008_simp3sect1.csv", row.names = 1, check.names = FALSE)
...
model <- make_model("cge_calib_chile_2008_simpl3sect1.gcn")
...
listcalib <- c(
    ...
    get_flow_values(1 - L_vals / V_vals, "beta_k", p_names),
    get_flow_values(L_vals / V_vals, "beta_l", p_names),
    get_flow_values(V_vals / (K_vals^(1 - L_vals / V_vals) * L_vals^(L_vals / V_vals)), "gamma", p_names)
)
