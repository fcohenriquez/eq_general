...
pdom_idx     <- 1:12
# pdom_arm_idx: Pdom_arm en el GCN (sin prod_adm_pub, indice 12 = cero estructural en M)
pdom_arm_idx <- 1:11
...
par_flat <- unlist(list(
    ...
    #get_flow_values(pmax(Z_v / pz_base, 1e-6)[pexp_idx], "Z0", p_names[pexp_idx]),
