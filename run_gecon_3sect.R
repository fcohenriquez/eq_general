...
# Tasa de IVA efectiva (Basada en demanda final doméstica)
# Los componentes Hogares, Gob, I, VarExis en la SAM suelen estar a precio de mercado.
VAR_EXIS_market_sam <- as.numeric(chile_sam[sam_p, "Var_Exis"])
total_final_demand_market <- D_market + GG_market + I_market + VAR_EXIS_market_sam
...
# Supply (Basic) = Output (V_product_vals) + Imports (M_vals)
# Demand (Basic) = D_vals + GG_vals + I_vals + VarExis_vals + rowSums(X_vals) + E_vals
# Despejamos VarExis_vals para cerrar el gap de la SAM
