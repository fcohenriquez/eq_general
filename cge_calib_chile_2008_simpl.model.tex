...
\begin{equation}
{I\!N\!C} = {B\!T\!I\!N\!C} - {{p\!i\!t}} {{P\!I\!T}^{\mathrm{base}}} + \sum_{s\in {S\!E\!C}} {\pi}^{\langle s\rangle}
\end{equation}
\begin{equation}
{B\!T\!I\!N\!C} = L^{\mathrm{h}} + {P\!R\!E\!S\!T}^{\mathrm{SOC}} + {T\!R}^{\mathrm{EMP}} + {T\!R}^{\mathrm{GOV}} + {p^{\mathrm{k}}} {K^{\mathrm{h}}}
\end{equation}
\begin{equation}
{P\!I\!T}^{\mathrm{base}} = L^{\mathrm{h}} + {p^{\mathrm{k}}} {K^{\mathrm{h}}}
\end{equation}
\begin{equation}
...
\begin{equation}
\sum_{p\in {P\!R\!O\!D\!S}} \sum_{s\in {S\!E\!C}} {L}^{\langle p,s\rangle} = L^{\mathrm{h}}
\end{equation}
\begin{equation}
\sum_{p\in {P\!R\!O\!D\!S}} {{p}^{\langle p\rangle}} {{I}^{\langle p\rangle}} = {S\!A\!V} + {S\!A\!V}^{\mathrm{F}} + {S\!A\!V}^{\mathrm{G}}
\end{equation}
\begin{equation}
p^{\mathrm{k}} = 1
\end{equation}
...
\end{equation}
\begin{equation}
L^{\mathrm{h}} - \sum_{p\in {P\!R\!O\!D\!S}} \sum_{s\in {S\!E\!C}} {L}^{\langle p,s\rangle} = 0
\end{equation}
\begin{equation}
...
\end{equation}
\begin{equation}
{S\!A\!V} + {S\!A\!V}^{\mathrm{F}} + {S\!A\!V}^{\mathrm{G}} - \sum_{p\in {P\!R\!O\!D\!S}} {{p}^{\langle p\rangle}} {{I}^{\langle p\rangle}} = 0
\end{equation}
\begin{equation}
...
\begin{equation}
-1 + {{\beta^{\mathrm{l}}}^{\langle \mathrm{\mathrm{Prod}},\mathrm{\mathrm{Act}}\rangle}} {{\gamma}^{\langle \mathrm{\mathrm{Prod}},\mathrm{\mathrm{Act}}\rangle}} {{p}^{\langle \mathrm{Prod}\rangle}} {{{K}^{\langle \mathrm{Prod},\mathrm{Act}\rangle}}^{{\beta^{\mathrm{k}}}^{\langle \mathrm{\mathrm{Prod}},\mathrm{\mathrm{Act}}\rangle}}} {{{L}^{\langle \mathrm{Prod},\mathrm{Act}\rangle}}^{-1 + {\beta^{\mathrm{l}}}^{\langle \mathrm{\mathrm{Prod}},\mathrm{\mathrm{Act}}\rangle}}} = 0
\end{equation}
\begin{equation}
1 - p^{\mathrm{k}} = 0
\end{equation}
...
\end{equation}
\begin{equation}
-p^{\mathrm{k}} + {{\beta^{\mathrm{k}}}^{\langle \mathrm{\mathrm{Prod}},\mathrm{\mathrm{Act}}\rangle}} {{\gamma}^{\langle \mathrm{\mathrm{Prod}},\mathrm{\mathrm{Act}}\rangle}} {{p}^{\langle \mathrm{Prod}\rangle}} {{{K}^{\langle \mathrm{Prod},\mathrm{Act}\rangle}}^{-1 + {\beta^{\mathrm{k}}}^{\langle \mathrm{\mathrm{Prod}},\mathrm{\mathrm{Act}}\rangle}}} {{{L}^{\langle \mathrm{Prod},\mathrm{Act}\rangle}}^{{\beta^{\mathrm{l}}}^{\langle \mathrm{\mathrm{Prod}},\mathrm{\mathrm{Act}}\rangle}}} = 0
\end{equation}
\begin{equation}
-{C\!O\!N\!T}^{\mathrm{SOC}} + {{p\!o\!r}^{\mathrm{cont}}} {{I\!N\!C}} = 0
\end{equation}
...
\end{equation}
\begin{equation}
L^{\mathrm{h}} - {L}^{\langle \mathrm{Prod},\mathrm{Act}\rangle} = 0
\end{equation}
\begin{equation}
-{P\!R\!E\!S\!T}^{\mathrm{SOC}^{\mathrm{F}}} + {{p\!o\!r}^{\mathrm{pres}^{\mathrm{soc}^{\mathrm{f}}}}} {{I\!N\!G}^{\mathrm{F}}} = 0
\end{equation}
...
\end{equation}
\begin{equation}
{S\!A\!V} + {S\!A\!V}^{\mathrm{F}} + {S\!A\!V}^{\mathrm{G}} - {{p}^{\langle \mathrm{Prod}\rangle}} {{I}^{\langle \mathrm{Prod}\rangle}} = 0
\end{equation}
\begin{equation}
-{T\!O\!T\!A\!L}^{\mathrm{TAX}} + {V\!A\!T} + {{p\!i\!t}} {{P\!I\!T}^{\mathrm{base}}} + {{f\!i\!t}} {p^{\mathrm{k}}} {K^{\mathrm{f}}} = 0
\end{equation}
\begin{equation}
{\pi}^{\langle \mathrm{Act}\rangle} + {L}^{\langle \mathrm{Prod},\mathrm{Act}\rangle} + {p^{\mathrm{k}}} {{K}^{\langle \mathrm{Prod},\mathrm{Act}\rangle}} - {{p}^{\langle \mathrm{Prod}\rangle}} {{Y}^{\langle \mathrm{Prod},\mathrm{Act}\rangle}} = 0
\end{equation}
\begin{equation}
