...
\end{equation}
\begin{equation}
{{d\!a\!t\!a}^{\mathrm{gg}^{\mathrm{p}}}}^{\langle \mathrm{\mathrm{Prod}}\rangle} - {{p}^{\langle \mathrm{Prod}\rangle}} {{{G\!G}}^{\langle \mathrm{Prod}\rangle}} \left(1 + {{v\!a\!t}}^{\langle \mathrm{\mathrm{Prod}}\rangle}\right) = 0
\end{equation}
\begin{equation}
-{C\!O\!N\!T}^{\mathrm{SOC}} + {{p\!o\!r}^{\mathrm{cont}}} {{I\!N\!C}} = 0
\end{equation}
...
\end{equation}
\begin{equation}
-{S\!A\!V}^{\mathrm{TOT}} + {{p}^{\langle \mathrm{Prod}\rangle}} {{I}^{\langle \mathrm{Prod}\rangle}} \left(1 + {{v\!a\!t}}^{\langle \mathrm{\mathrm{Prod}}\rangle}\right) = 0
\end{equation}
\begin{equation}
-{S\!A\!V}^{\mathrm{G}} + {{p\!o\!r}^{\mathrm{sav}^{\mathrm{g}}}} {{I\!N\!G}^{\mathrm{GOB}}} = 0
\end{equation}
...
\end{equation}
\begin{equation}
-{{D\!A}}^{\langle \mathrm{Prod}\rangle} + {{p}^{\langle \mathrm{Prod}\rangle}} \left(1 + {{v\!a\!t}}^{\langle \mathrm{\mathrm{Prod}}\rangle}\right) \left({D}^{\langle \mathrm{Prod}\rangle} + {{G\!G}}^{\langle \mathrm{Prod}\rangle} + {I}^{\langle \mathrm{Prod}\rangle}\right) = 0
\end{equation}
\begin{equation}
{{D\!A}}^{\langle \mathrm{Prod}\rangle} - {{{O\!A}}^{\langle \mathrm{Prod}\rangle}} \left(1 + {{v\!a\!t}}^{\langle \mathrm{\mathrm{Prod}}\rangle}\right) = 0
\end{equation}
\begin{equation}
-{{O\!A}}^{\langle \mathrm{Prod}\rangle} + {{p}^{\langle \mathrm{Prod}\rangle}} {{Y}^{\langle \mathrm{Prod},\mathrm{Act}\rangle}} = 0
\end{equation}
\begin{equation}
